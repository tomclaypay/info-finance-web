...
const LatestNewsItem = ({ data, image = true, highlight = false }: LatestNewsItemProps) => {
  ...
  return (
    ...
    >
      ...
      <Link href={`/${locale === 'vi' ? 'tin-tuc' : 'news'}/${dataArticle?.slug}`} passHref component={NextLink}>
        <Typography
          variant="h3"
          sx={{
            height: '100%',
