...
interface LicenseChildCardProps {
  child: DocumentaryEvidence
...
const LicenseChildCard = ({ child, childSection, setChildSection, index, label }: LicenseChildCardProps) => {
  ...
  return (
    ...
    >
      ...
      <Stack flex={1} direction="row" spacing={2} justifyContent="flex-end">
        <Button onClick={() => handleRemoveChild(child.id)} variant="contained" sx={{ textTransform: 'capitalize' }}>
...
export default LicenseChildCard
