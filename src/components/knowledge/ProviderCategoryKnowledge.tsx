...
const ProviderCategoryKnowledge = ({ data, owner, home, title, knowledgeCategorySlug, detail }: ExchangesNewsProps) => {
...
export default ProviderCategoryKnowledge
