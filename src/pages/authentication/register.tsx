...
const Register = () => {
  ...
  return (
    <>
      <Head>
        <title>Register | Info Finance</title>
      </Head>
      <Box
        component="main"
        sx={{
        ...
        >
          {!isDesktop ? (
            <Stack alignItems="center" spacing={5} pb={5}>
              ...
              <Card elevation={16} sx={{ p: '16px', borderRadius: 2 }}>
                <Box
                  sx={{
            ...
            <Grid container spacing={12} sx={{ width: '100%', height: '100%' }}>
              ...
              >
                <Card elevation={16} sx={{ p: 4, borderRadius: 2 }}>
                  ...
                  >
                    <Typography variant="h4"> {t('authen.register')}</Typography>
                    <Stack sx={{ mt: 2 }} direction="row" spacing={0.75}>
...
Register.getLayout = (page: ReactElement) => <GuestGuard>{page}</GuestGuard>
