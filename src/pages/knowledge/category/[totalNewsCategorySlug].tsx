...
import { articleCategorySlugType, getSlugs } from '@app/pages/knowledge'
...
const TotalNewsCategorySlug = ({ dataArticlesEachPage, dataArticlesCategories }: TotalNewsCategorySlugProps) => {
  ...
  const titleSEO = {
    'kien-thuc-dau-tu': t('investment-knowledge.title', { ns: 'seo' }),
    'investment-knowledge': t('investment-knowledge.title', { ns: 'seo' }),
    'lua-chon-nha-moi-gioi': t('choose-broker.title', { ns: 'seo' }),
    'choose-broker': t('choose-broker.title', { ns: 'seo' }),
    'y-tuong-dau-tu': t('investment-ideas.title', { ns: 'seo' }),
    'investment-ideas': t('investment-ideas.title', { ns: 'seo' }),
  }
  const desSEO = {
    'kien-thuc-dau-tu': t('investment-knowledge.description', { ns: 'seo' }),
    'investment-knowledge': t('investment-knowledge.description', { ns: 'seo' }),
    'lua-chon-nha-moi-gioi': t('choose-broker.description', { ns: 'seo' }),
    'choose-broker': t('choose-broker.description', { ns: 'seo' }),
    'y-tuong-dau-tu': t('investment-ideas.description', { ns: 'seo' }),
    'investment-ideas': t('investment-ideas.description', { ns: 'seo' }),
  }
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative' }}>
          <Stack direction="row" sx={{ position: 'relative' }}>
            <Stack sx={{ flex: '3' }}>
              <Stack direction="row">
                <Link component={NextLink} href="/knowledge" passHref>
                  <Typography
                    variant="body2"
                ...
                <Image
                  ...
                  loading="lazy"
                />
                <Link component={NextLink} href={`/knowledge/category/${totalNewsCategorySlug}`} passHref>
                  <Typography
                    variant="body2"
                    sx={{
                      color: 'text.main',
          ...
          <Pagination
            ...
            renderItem={(item) => (
              <PaginationItem
                ...
                href={`/knowledge/category/${totalNewsCategorySlug}${item.page === 1 ? '' : `?page=${item.page}`}`}
                {...item}
              />
            )}
          />
