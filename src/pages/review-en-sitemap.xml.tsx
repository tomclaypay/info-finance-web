...
<url>
<loc>${process.env.NEXT_PUBLIC_SITE_URL}en/exchange-review</loc>
<lastmod>${lastmod}</lastmod>
</url>
<url>
<loc>${process.env.NEXT_PUBLIC_SITE_URL}en/exchange-review/scam</loc>
<lastmod>${lastmod}</lastmod>
</url>
<url>
<loc>${process.env.NEXT_PUBLIC_SITE_URL}en/exchange-review/investor-feedback-and-comments-mailbox</loc>
<lastmod>${lastmod}</lastmod>
</url>
<url>
<loc>${process.env.NEXT_PUBLIC_SITE_URL}en/exchange-review/general-review</loc>
<lastmod>${lastmod}</lastmod>
</url>
<url>
<loc>${process.env.NEXT_PUBLIC_SITE_URL}en/exchange-review/other-problems</loc>
<lastmod>${lastmod}</lastmod>
</url>
${complaints
  ?.map(
    (complaint) => `<url>
  <loc>${process.env.NEXT_PUBLIC_SITE_URL}en/exchange-review${complaint?.slug ? `/${complaint?.slug}` : ''}</loc>
